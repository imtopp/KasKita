...
- [x] Fix PDF: **jarak logo ke teks header** — margin logo 64×64 diperbesar dari `[0,0,12,0]` menjadi `[0,8,16,0]` (16pt jeda horizontal ke judul + 8pt offset vertikal agar sejajar dengan blok teks) di `lib/pdf/report.ts`.
