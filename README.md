...
- **Perilaku navigasi native mobile**: Back menutup dialog lebih dulu (dropdown tidak lagi menangkap Back — pernah menyebabkan filter/select tidak bisa di-set); ganti tab dengan dashboard sebagai root (Back selalu kembali ke Dashboard); header menampilkan nama aplikasi + org switcher berikon + tema ikon
